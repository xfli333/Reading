 ...
 * Time: AM10:51
 */
public class SecondPageActivity extends BasePageActivity implements GestureDetector.OnGestureListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mController = new PageController(this, FirstPageActivity.class);
...
//    }
    ...
    public boolean onFling(MotionEvent motionEvent1, MotionEvent motionEvent2, float v, float v2) {
        boolean isScroll = Math.abs(motionEvent1.getY() - motionEvent2.getY()) < mController.FLING_SCROLL_DISTANCE;

        if (motionEvent1.getX() - motionEvent2.getX() > mController.FLING_MIN_DISTANCE && isScroll) {
            // Fling left NExt
        ...
        } else if (motionEvent2.getX() - motionEvent1.getX() > mController.FLING_MIN_DISTANCE && isScroll) {
            // Fling right
